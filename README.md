...
| Timezone      | Time zone of the player as the platform abbreviated it (null when absent)   | BRT                               | string          |
...
| Timezone      | Time zone of the player, as abbreviated by the platform             | BRT                 |
